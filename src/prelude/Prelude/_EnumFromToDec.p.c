...
#define v188	((void*)startLabel+44)
...
#define PS_v197	((void*)startLabel+420)
...
,	/* v187: (byte 2) */
  bytes2word(TOP(46),BOT(46),POP_I1,PUSH_HEAP)
...
,	/* v189: (byte 2) */
  bytes2word(11,RETURN,POP_I1,HEAP_CVAL_P1)
...
,};
Node PP_Prelude_46_95enumFromToDec[] = {
 };
Node PC_Prelude_46_95enumFromToDec[] = {
 	/* ST_v191: (byte 0) */
...
,	/* PS_v195: (byte 0) */
  useLabel(PM_Prelude)
, useLabel(PP_Prelude_46_95enumFromToDec)
