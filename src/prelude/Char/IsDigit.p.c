...
, 0
,};
Node F0_Char_46isDigit[] = {
  CAPTAG(useLabel(FN_Char_46isDigit),1)
, useLabel(PS_v168)
, 0
, 0
, 0
...
,};
Node PP_Char_46isDigit[] = {
 };
Node PC_Char_46isDigit[] = {
 	/* ST_v169: (byte 0) */
