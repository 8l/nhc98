...
, bytes2word(48,HEAP_CVAL_P1,8,HEAP_CVAL_N1)
...
, bytes2word(HEAP_SPACE,HEAP_ARG,1,HEAP_CHAR_P1)
, bytes2word(70,HEAP_CVAL_P1,9,HEAP_CVAL_N1)
...
, bytes2word(HEAP_SPACE,HEAP_SPACE,HEAP_ARG,1)
, bytes2word(HEAP_CHAR_P1,102,HEAP_CVAL_P1,9)
...
,};
Node PP_Char_46isHexDigit[] = {
 };
Node PC_Char_46isHexDigit[] = {
 	/* ST_v178: (byte 0) */
  bytes2word(67,104,97,114)
, bytes2word(46,105,115,72)
, bytes2word(101,120,68,105)
, bytes2word(103,105,116,0)
,	/* PS_v182: (byte 0) */
  useLabel(PM_Char)
, useLabel(PP_Char_46isHexDigit)
