...
extern Node PC_Numeric_46FFFixed[];
...
, 0
,};
Node F0_Numeric_46showFFloat[] = {
  CAPTAG(useLabel(FN_Numeric_46showFFloat),3)
, useLabel(PS_v184)
, 0
, 0
, 0
...
,};
Node PP_Numeric_46showFFloat[] = {
 };
Node PC_Numeric_46showFFloat[] = {
 	/* ST_v185: (byte 0) */
  bytes2word(78,117,109,101)
, bytes2word(114,105,99,46)
, bytes2word(115,104,111,119)
, bytes2word(70,70,108,111)
, bytes2word(97,116,0,0)
,	/* PS_v186: (byte 0) */
  useLabel(PM_Numeric)
, useLabel(PP_Numeric_46showFFloat)
