...
#define F0_NHC_46Binary_46hs_95freezeBin_35	((void*)startLabel+40)
#define FN_NHC_46Binary_46hs_95freezeBin	((void*)startLabel+68)
#define CT_v210	((void*)startLabel+120)
#define CF_NHC_46Binary_46hs_95freezeBin	((void*)startLabel+128)
...
#define PP_LAMBDA202	((void*)startLabel+453)
#define PC_LAMBDA202	((void*)startLabel+453)
#define ST_v219	((void*)startLabel+453)
#define PP_NHC_46Binary_46hs_95freezeBin	((void*)startLabel+486)
#define PC_NHC_46Binary_46hs_95freezeBin	((void*)startLabel+486)
#define ST_v208	((void*)startLabel+486)
#define PP_NHC_46Binary_46hs_95freezeBin_35	((void*)startLabel+510)
#define PC_NHC_46Binary_46hs_95freezeBin_35	((void*)startLabel+510)
#define ST_v205	((void*)startLabel+510)
#define PS_v209	((void*)startLabel+536)
#define PS_v207	((void*)startLabel+548)
#define PS_v214	((void*)startLabel+560)
#define PS_v213	((void*)startLabel+572)
#define PS_v211	((void*)startLabel+584)
#define PS_v216	((void*)startLabel+596)
#define PS_v215	((void*)startLabel+608)
#define PS_v204	((void*)startLabel+620)
#define PS_v220	((void*)startLabel+632)
#define PS_v218	((void*)startLabel+644)
...
,};
Node PP_NHC_46Binary_46freezeBin[] = {
 };
Node PC_NHC_46Binary_46freezeBin[] = {
 	/* ST_v212: (byte 0) */
...
,	/* PP_NHC_46Binary_46hs_95freezeBin: (byte 2) */
 	/* PC_NHC_46Binary_46hs_95freezeBin: (byte 2) */
 	/* ST_v208: (byte 2) */
...
, bytes2word(102,114,101,101)
, bytes2word(122,101,66,105)
,	/* PP_NHC_46Binary_46hs_95freezeBin_35: (byte 2) */
 	/* PC_NHC_46Binary_46hs_95freezeBin_35: (byte 2) */
 	/* ST_v205: (byte 2) */
...
, useLabel(PP_NHC_46Binary_46hs_95freezeBin)
, useLabel(PC_NHC_46Internal_46_95mkIOok1)
,	/* PS_v207: (byte 0) */
  useLabel(PM_NHC_46Binary)
, useLabel(PP_NHC_46Binary_46hs_95freezeBin)
, useLabel(PC_NHC_46Binary_46hs_95freezeBin)
,	/* PS_v214: (byte 0) */
  useLabel(PM_NHC_46Binary)
, useLabel(PP_NHC_46Binary_46freezeBin)
...
,	/* PS_v211: (byte 0) */
  useLabel(PM_NHC_46Binary)
, useLabel(PP_NHC_46Binary_46freezeBin)
, useLabel(PC_NHC_46Binary_46freezeBin)
,	/* PS_v216: (byte 0) */
  useLabel(PM_NHC_46Binary)
, useLabel(PP_NHC_46Binary_46freezeBin)
...
,	/* PS_v204: (byte 0) */
  useLabel(PM_NHC_46Binary)
, useLabel(PP_NHC_46Binary_46hs_95freezeBin_35)
, useLabel(PC_NHC_46Binary_46hs_95freezeBin_35)
,	/* PS_v220: (byte 0) */
  useLabel(PM_NHC_46Binary)
